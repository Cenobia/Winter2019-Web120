...
#EDIT THE FOLLOWING:
$toAddress = "fruitcupkun@gmail.com";  //place your/your client's email address here
$toName = "Devan"; //place your client's name here
$website = "Orth";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>
		<label>
			<br /><input type="text" name="Name" required="required" placeholder="Full Name (required)" title="Name is required" tabindex="10" size="44" autofocus />
		</label>
    </div>
	...
	<div>	
		<label>
			<br /><input type="email" name="Email" required="required" placeholder="Email (required)" title="A valid email is required" tabindex="20" size="44" />
		</label>
	</div>
	...
	<div>	
		<label>
		    <br /><textarea name="Comments" cols="36" rows="4" placeholder="Briefly describe your inquiry." tabindex="30"></textarea>
		</label>
    </div>
